...
//one to one bolje
    ...
    public Menadzer( String korisnicko_ime, String lozinka, String ime, String prezime, String pol, String datum_rodjenja, String uloga) {
    ...
    public Menadzer( String korisnicko_ime, String lozinka, String ime, String prezime, String pol, String datum_rodjenja, String uloga, Set<Restoran> restorani) {
        super( korisnicko_ime, lozinka, ime, prezime, pol, datum_rodjenja, uloga);
        this.restorani = restorani;
    }
